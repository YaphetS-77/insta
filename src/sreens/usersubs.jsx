...
const Usersub = () => {
    ...
    const subs = subsc.filter(i => i.user_id == id);
    console.table(subs)
    const UserLogged = () => {
        if (local == null) {
        ...
        <div className="container-fluid height">
            <div className="row">
                <div className="col-md-12">
                    <div className="row">
                        <div className="col-md-12">
                            <a className="text-dark" href={"/userprofile/" + id}><i class="fa-solid fa-arrow-left-long fa-3x"></i></a> <big><b class="ps-4 text">{userDetails[0].name}</b></big>
                        </div>
                    </div>
                    <div class="row mt-3">
